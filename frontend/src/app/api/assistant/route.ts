...
/**
 * Build the Buni AI system prompt with injected simulation data
...
function buildSystemPrompt(simulationData: unknown, graphContext: string): string {
  ...
  return `You are Buni AI — an expert marketing analytics assistant for the brandOS platform. You help Bangladeshi SME marketers understand their campaign simulation results.
 ...
 * POST /api/assistant
 *
 * Streaming chat endpoint for the Buni AI chatbot widget.
