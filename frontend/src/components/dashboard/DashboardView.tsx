    ...
    <div className="flex flex-col gap-8 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 min-w-0">
        ...
        <div className="flex flex-col gap-8 min-w-0">
          ...
          {/* AI Recommendations */}
          <Card className="border border-[#E5E5E5] bg-white shadow-sm flex-grow flex flex-col transition-all hover:shadow-md rounded-2xl">
                  ...
                  optimization_result.recommendations.map((rec) => (
                    ...
                    >
                      <div className="flex flex-col gap-2.5 pr-4">
                        ...
                        <span className="text-sm font-medium text-[#0A0A0A] leading-snug">{rec.recommendation_reasoning}</span>
                      </div>
